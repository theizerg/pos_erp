...
<html> 
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('vendor/bootstrap-toggle/css/bootstrap-toggle.min.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('vendor/bootstrap/css/bootstrap-datepicker.min.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('vendor/jquery-timepicker/jquery.timepicker.min.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(asset('vendor/bootstrap/css/awesome-bootstrap-checkbox.css')); ?>" type="text/css">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('vendor/daterange/css/daterangepicker.min.css')); ?>" type="text/css">
    <!-- table sorter stylesheet-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendor/datatable/dataTables.bootstrap4.min.css')); ?>">
    ...
    <script type="text/javascript" src="<?php echo e(asset('vendor/keyboard/js/jquery.keyboard.extension-autocomplete.js')); ?>"></script>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/custom-'.$general_setting->theme)); ?>" type="text/css" id="custom-style">
  </head>
    ...
    <div class="page">
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <p>&copy; <?php echo e($general_setting->developed_by); ?> | <?php echo e(trans('file.Developed')); ?> <?php echo e(trans('file.By')); ?> <span class="external">Theizer Gonzalez</span></p>
            </div>
          </div>
        </div>
      </footer>
...
</html><?php /**PATH C:\laragon\www\erp_pos\resources\views/layout/main.blade.php ENDPATH**/ ?>