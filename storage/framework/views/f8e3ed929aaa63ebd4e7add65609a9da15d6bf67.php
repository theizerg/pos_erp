...
<section>
    <div class="container-fluid">
        <a href="<?php echo e(url('qty_adjustment/create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(trans('file.Add Adjustment')); ?></a>
    </div>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li class="divider"></li>
                                <?php echo e(Form::open(['url' => ['qty_adjustment/destroy', $adjustment->id], 'method' => 'DELETE'] )); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\erp_pos\resources\views/adjustment/index.blade.php ENDPATH**/ ?>