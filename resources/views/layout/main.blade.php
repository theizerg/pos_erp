...
<html> 
  <head>
    ...
    <script type="text/javascript" src="{{ asset('vendor/keyboard/js/jquery.keyboard.extension-autocomplete.js') }}"></script>
    ...
    <div class="page">
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <p>&copy; {{$general_setting->developed_by}} | {{trans('file.Developed')}} {{trans('file.By')}} <span class="external">Theizer Gonzalez</span></p>
            </div>
          </div>
        </div>
      </footer>
